...
export default function Contact() {
    ...
    const disable = userData.name.length === 0 || userData.mail.length === 0 || userData.phone_number.length === 0 || userData.message.length === 0;
        ...
        <div id="contact">
            ...
            <div className="contact-form"
                ...
                <form className="form">
                    ...
                    <p className={classes.error}> {error.message ? error.message : <br />} </p>
